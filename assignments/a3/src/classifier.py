...
def eval_model(model, X_test_, y_test_,labelNames):
    ...
    print(classification_report(y_test_.argmax(axis=1),
...
def write_report(evaluation_report, path_out):
    with open(path_out, "w") as file:
        file.write(evaluation_report)

def main():
    path_in = os.path.join(".", "in", "Tobacco3482")
    path_out = os.path.join(".", "out", "classification_report.txt")
    ...
    write_report(evaluation_report, path_out)
